...
describe 'BipMnemonic class' do
  describe 'mnemonic generation and entropy conversion' do
    shared_examples 'mnemonic and entropy conversion' do |entropy, mnemonic|
      it "generates correct mnemonic for given entropy #{entropy}" do
        expect(BipMnemonic.new.to_mnemonic(entropy: entropy)).to eql mnemonic
      end

      it "generates correct entropy for given mnemonic #{mnemonic}" do
        expect(BipMnemonic.new.to_entropy(mnemonic: mnemonic)).to eq entropy
      end
    end

    include_examples 'mnemonic and entropy conversion', '00000000000000000000000000000000',
                     'abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon about'
    include_examples 'mnemonic and entropy conversion', '7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f',
                     'legal winner thank year wave sausage worth useful legal winner thank yellow'
    include_examples 'mnemonic and entropy conversion', '80808080808080808080808080808080',
                     'letter advice cage absurd amount doctor acoustic avoid letter advice cage above'
    include_examples 'mnemonic and entropy conversion', 'ffffffffffffffffffffffffffffffff',
                     'zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo wrong'
    include_examples 'mnemonic and entropy conversion', '000000000000000000000000000000000000000000000000',
                     'abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon agent'
    include_examples 'mnemonic and entropy conversion', '7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f',
                     'legal winner thank year wave sausage worth useful legal winner thank year wave sausage worth useful legal will'
    include_examples 'mnemonic and entropy conversion', '808080808080808080808080808080808080808080808080',
                     'letter advice cage absurd amount doctor acoustic avoid letter advice cage absurd amount doctor acoustic avoid letter always'
    include_examples 'mnemonic and entropy conversion', 'ffffffffffffffffffffffffffffffffffffffffffffffff',
                     'zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo when'
    include_examples 'mnemonic and entropy conversion',
    ...
    include_examples 'mnemonic and entropy conversion', '9e885d952ad362caeb4efe34a8e91bd2',
                     'ozone drill grab fiber curtain grace pudding thank cruise elder eight picnic'
    include_examples 'mnemonic and entropy conversion', '6610b25967cdcca9d59875f5cb50b0ea75433311869e930b',
    ...
    include_examples 'mnemonic and entropy conversion', 'c0ba5a8e914111210f2bd131f3d5e08d',
                     'scheme spot photo card baby mountain device kick cradle pact join borrow'
    include_examples 'mnemonic and entropy conversion', '6d9be1ee6ebd27a258115aad99b7317b9c8d28b6d76431c3',
    ...
    include_examples 'mnemonic and entropy conversion', '23db8160a31d3e0dca3688ed941adbf3',
                     'cat swing flag economy stadium alone churn speed unique patch report train'
    include_examples 'mnemonic and entropy conversion', '8197a4a47f0425faeaa69deebc05ca29c0a5b5cc76ceacc0',
    ...
    include_examples 'mnemonic and entropy conversion', 'f30f8c1da665478f49b001d94c5fc452',
                     'vessel ladder alter error federal sibling chat ability sun glass valve picture'
    include_examples 'mnemonic and entropy conversion', 'c10ec20dc3cd9f652c7fac2f1230f7a3c828389a14392f05',
  ...
  describe 'mnemonic word count for different bits' do
    { 128 => 12, 192 => 18, 256 => 24, 320 => 30, 384 => 36, 448 => 42, 512 => 48 }.each do |bits, word_count|
      it "generates correct count of #{word_count} mnemonic words for #{bits} bits" do
        expect(BipMnemonic.new.to_mnemonic(bits: bits).split.count).to eq word_count
      end
    end
  end

  describe 'uniqueness of generated mnemonics' do
    [128, 256, 512].each do |bits|
      [10, 50, 100, 2048].each do |iterations|
        it "generates unique mnemonics for #{iterations} iterations with #{bits} bits" do
          mnemonics = iterations.times.map { BipMnemonic.new.to_mnemonic(bits: bits) }
          expect(mnemonics.uniq.count).to eq iterations
        end
      end
    end
  end

  describe 'seed generation from mnemonic' do
    shared_examples 'correct seed generation' do |mnemonic, expected_seed|
      it "generates correct seed for mnemonic '#{mnemonic}'" do
        expect(BipMnemonic.new.to_seed(salt: 'TREZOR', mnemonic: mnemonic)).to eq expected_seed
      end
    end

    include_examples 'correct seed generation',
    ...
    include_examples 'correct seed generation', 'zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo wrong',
